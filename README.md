...
This project applies binary search rules to guess a number between 0 and 300 that the user has chosen. The project was created using TypeScript, React, Styled-components and Storybook.

This project is a variation of the "binary search" project that Tulio Faria teaches in his course "DevReactJS"
